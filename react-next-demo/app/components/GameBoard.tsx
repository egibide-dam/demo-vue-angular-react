...
// Props que recibe GameBoard desde page.tsx (el componente raíz con el estado).
...
// 'onCellClick': callback que page.tsx ejecutará con el índice de la celda pulsada.
